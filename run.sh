...
if [ $mode == "test" ]; then
    python main.py -i ../artifact2/1_merge_iban/merged.csv -s make_submission -o ../artifact2/1_merge_iban/submission.csv
fi
...
if [ $mode == "test" ]; then
    python main.py -i ../artifact2/2_merge_phone/merged.csv -s make_submission -o ../artifact2/2_merge_phone/submission.csv
fi
...
if [ $mode == "test" ]; then
    python main.py -i ../artifact2/3_merge_name/merged.csv -s make_submission -o ../artifact2/3_merge_name/submission.csv
fi
